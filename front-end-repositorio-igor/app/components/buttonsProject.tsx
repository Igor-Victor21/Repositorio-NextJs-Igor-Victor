        ...
        <section>
            <div className="flex flex-row gap-[10px] md:mb-[20px]">
                <div className="flex p-2 rounded-[50px] bg-[#F5F5F5] w-[128.76px] md:w-[168.76px] h-[46px] items-center justify-center">
                    <Link href="https://vc-brinquedos-espumados-site-next.vercel.app/" target="_blank" rel="noopener noreferrer" className="flex gap-1 text-[#121212] font-medium cursor-pointer hover:tracking-wide duration-200">SITE
